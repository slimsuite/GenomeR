...
simple_count = simple_count_kmer(params$df, simple_min, simple_max, show_error = show)
...
peak_count = peak_count_kmer(params$df, peak_min, peak_max, show_error = show, num_peaks)
```
